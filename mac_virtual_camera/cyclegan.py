...
def main():
    ...
    # TODO: 
    # do to device here instead of in sub function
    # abstract load model
    ...
    net = define_G(input_nc=3,output_nc=3, ngf=64, netG="resnet_9blocks", norm='instance', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[0])

    state_dict = torch.load("checkpoints/horse2zebra_pretrained/latest_net_G.pth", map_location=str(device))
